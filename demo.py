...
img_raw = mmcv.imread("demo/bottle.jpg")
...
for cc_key, cc_value in coco_80_dict.items():
    ...
    # coco_80_dict[cc_key]["score"] = res["scores"][cc_value["index"]]
# print(coco_80_dict)
# print("**********************")
img_detection = deepcopy(img_raw)  # 深拷贝原始 numpy.ndarray 对象
img_detection_data = coco_80_dict["bottle"]["detection"][0]  # 第1个板凳的检测框

print("**********************")
print(
    img_detection_data
)  # [182.87999    36.909924  282.9722    278.84326     0.9984151]
print("**********************")
